...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Jan 25. 10:37
...
INSERT INTO `felhasznalok` (`id`, `nev`, `email`, `jelszo`, `telefonszam`, `lakcim`, `szallitasi_cim`) VALUES
(1, '', '', '', 0, '', ''),
(2, 'menjhaza', 'email@gmail.com', 'anyad', 0, '', '');
